    ...
    static async addPendapatan(transaksi, listProduk, res) {
        try {
            ...
            listProduk.forEach((produk, index) => {
                const totalPendapatanProduk = produk.hargaProduk * transaksi.idProduk[index].jumlahProduk;

                if (produk.kategoriProduk === 'Makanan') {
                    findPendapatan.pendapatanMakanan += totalPendapatanProduk;
                } else if (produk.kategoriProduk === 'Minuman') {
                    findPendapatan.pendapatanMinuman += totalPendapatanProduk;
                }
            });
