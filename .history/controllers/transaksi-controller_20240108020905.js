...
class TransaksiController {
    ...
    static async getHourlyEarnings(req, res, next) {
        try {
            ...
            const transaksiInRange = await Transaksi.find({
                tanggalTransaksi: {
                    $gte: startDateWithTime.toDate(),
                    $lte: endDateWithTime.toDate()
                }
            });

            console.log("Found transactions:", transaksiInRange);
