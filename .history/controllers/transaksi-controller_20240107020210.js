    ...
    static async addTransaksi(req, res, next) {
        try {
            ...
            for (let i = 0; i < transaksiData.idProduk.length; i++) {
                ...
                transaksi.idProduk[i].subTotalProduk = subTotalProduk;
                transaksi.totalHarga += transaksi.idProduk[i].subTotalProduk;
                transaksi.jumlahProduk += transaksi.idProduk[i].jumlahProduk;
                console.log('======' + transaksi.idProduk[i].subTotalProduk);
            }
